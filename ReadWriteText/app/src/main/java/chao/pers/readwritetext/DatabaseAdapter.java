...
public class DatabaseAdapter {
    ...
    //凭name查询
    public Dog findById(String name){
        ...
        Cursor c=db.query(true,PetMetaData.DogTable.TABLE_NAME,colums,PetMetaData.DogTable.NAME+"=?",new String[]{String.valueOf(name)},null,null,null,null);
        Dog dog=null;
        if(c.moveToNext()){
            dog=new Dog();
